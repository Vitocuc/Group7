...
/* Priorità dei Task */
#define MASTER_TASK_PRIORITY (tskIDLE_PRIORITY + 3)
...
#define MASTER_TASK_STACK_SIZE (configMINIMAL_STACK_SIZE + 1000)
#define SLAVE_TASK_STACK_SIZE (configMINIMAL_STACK_SIZE + 1000)
