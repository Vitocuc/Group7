...
#include "Mcal.h"
#include "OsIf.h"
#include "Flexio_Spi_Ip_Sa_PBcfg.h"
...
/* Check if Flexio_Spi_PBcfg header file and Spi configuration header file are of the same vendor */
#if (FLEXIO_SPI_IP_SA_VENDOR_ID_PBCFG != FLEXIO_SPI_IP_VENDOR_ID_CFG)
    #error "Flexio_Spi_Ip_Sa_PBcfg.h and FLEXIO_SPI_IP_Cfg.h have different vendor IDs"
#endif
    /* Check if Flexio_Spi_Ip_PBcfg header file and Spi  configuration header file are of the same Autosar version */
#if ((FLEXIO_SPI_IP_SA_AR_RELEASE_MAJOR_VERSION_PBCFG != FLEXIO_SPI_IP_AR_RELEASE_MAJOR_VERSION_CFG) || \
     (FLEXIO_SPI_IP_SA_AR_RELEASE_MINOR_VERSION_PBCFG != FLEXIO_SPI_IP_AR_RELEASE_MINOR_VERSION_CFG) || \
     (FLEXIO_SPI_IP_SA_AR_RELEASE_REVISION_VERSION_PBCFG != FLEXIO_SPI_IP_AR_RELEASE_REVISION_VERSION_CFG))
    #error "AutoSar Version Numbers of Flexio_Spi_Ip_Sa_PBcfg.h and Flexio_Spi_Ip_Cfg.h are different"
#endif
/* Check if Flexio_Spi_Ip_PBcfg header file and Spi configuration header file are of the same software version */
#if ((FLEXIO_SPI_IP_SA_SW_MAJOR_VERSION_PBCFG != FLEXIO_SPI_IP_SW_MAJOR_VERSION_CFG) || \
     (FLEXIO_SPI_IP_SA_SW_MINOR_VERSION_PBCFG != FLEXIO_SPI_IP_SW_MINOR_VERSION_CFG) || \
     (FLEXIO_SPI_IP_SA_SW_PATCH_VERSION_PBCFG != FLEXIO_SPI_IP_SW_PATCH_VERSION_CFG))
    #error "Software Version Numbers of Flexio_Spi_Ip_Sa_PBcfg.h and Flexio_Spi_Ip_Cfg.h are different"
#endif
/*==================================================================================================
                                            CONSTANTS
==================================================================================================*/
...
#define FLEXIO_SPI_IP_SLAVE_SUPPORT  (STD_ON)
...
#define FLEXIO_SPI_IP_DEV_ERROR_DETECT     (STD_ON)
