...
#else
    #error "CHANNEL_0 cannot be used by SPI driver to configure as TX channel. Channel locked by another driver!"
#endif

#ifndef FLEXIO_0_CH_1_USED
    #define FLEXIO_0_CH_1_USED
#else
    #error "CHANNEL_1 cannot be used by SPI driver to configure as RX channel. Channel locked by another driver!"
#endif
...
#else
    #error "PIN_0 cannot be used by SPI driver to configure as TX channel. Channel locked by another driver!"
#endif

#ifndef FLEXIO_0_PIN_1_USED
    #define FLEXIO_0_PIN_1_USED
#else
    #error "PIN_1 cannot be used by SPI driver to configure as RX channel. Channel locked by another driver!"
#endif

#ifndef FLEXIO_0_PIN_12_USED
    #define FLEXIO_0_PIN_12_USED
#else
    #error "PIN_12 cannot be used by SPI driver to configure as CLK channel. Channel locked by another driver!"
#endif

#ifndef FLEXIO_0_PIN_14_USED
    #define FLEXIO_0_PIN_14_USED
#else
    #error "PIN_14 cannot be used by SPI driver to configure as CS channel. Channel locked by another driver!"
#endif
/* Macros that indicate FLEXIO channels used by SPI */
